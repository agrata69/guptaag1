...
public class JSONTranslationExample {
    ...
    public String getCanadaCountryNameSpanishTranslation() {
        ...
        if (canada.has("translations")) {
            return canada.getJSONObject("translations").optString("es", "Translation not found");
        } else {
    ...
    public String getCountryNameTranslation(String countryCode, String languageCode) {
        ...
        // Return "Translations not found" for unsupported language codes
        return "Translations not found";
    }
    /**
